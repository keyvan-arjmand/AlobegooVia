...
namespace MLModel_ConsoleApp1
{
    public partial class MLModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("RowNumber");
            if (labelColumn == null)
            {
                throw new Exception("RowNumber column not found. Make sure the name searched for matches the name in the schema.");
            }
