...
namespace MLModel_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Tanin\Downloads\generated_appliance_repairs.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"RowNumber",inputColumnName:@"RowNumber",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"RowNumber", sentence1ColumnName: @"Problem"))      
